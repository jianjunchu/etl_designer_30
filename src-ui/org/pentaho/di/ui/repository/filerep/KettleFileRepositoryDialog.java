  ...
  public KettleFileRepositoryMeta open(final MODE mode){
    ...
    wbBaseDir.addSelectionListener(new SelectionAdapter() {
      public void widgetSelected(SelectionEvent arg0) {
        ...
        dialog.setText(BaseMessages.getString(PKG,"KettleFileRepositoryDialog.SelectRootDirectory.Title"));
        dialog.setMessage(BaseMessages.getString(PKG,"KettleFileRepositoryDialog.SelectTheRepositoryRootDirectory.description"));
