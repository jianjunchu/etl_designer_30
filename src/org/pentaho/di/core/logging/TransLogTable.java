...
public class TransLogTable extends BaseLogTable implements Cloneable, LogTableInterface {
  ...
  private List<StepMeta> steps;
	...
	public static TransLogTable getDefault(VariableSpace space, HasDatabasesInterface databasesInterface, List<StepMeta> steps) {
		...
		table.fields.add( new LogTableField(ID.VARIABLE1.id, true, true, "VARIABLE1", BaseMessages.getString(PKG, "TransLogTable.FieldName.Variable1"), BaseMessages.getString(PKG, "TransLogTable.FieldDescription.LogField"), ValueMetaInterface.TYPE_STRING, 255) );
		table.fields.add( new LogTableField(ID.VARIABLE2.id, true, true, "VARIABLE2", BaseMessages.getString(PKG, "TransLogTable.FieldName.Variable2"), BaseMessages.getString(PKG, "TransLogTable.FieldDescription.LogField"), ValueMetaInterface.TYPE_STRING, 255) );
		table.fields.add( new LogTableField(ID.VARIABLE3.id, true, true, "VARIABLE3", BaseMessages.getString(PKG, "TransLogTable.FieldName.Variable3"), BaseMessages.getString(PKG, "TransLogTable.FieldDescription.LogField"), ValueMetaInterface.TYPE_STRING, 255) );
		table.fields.add( new LogTableField(ID.VARIABLE4.id, true, true, "VARIABLE4", BaseMessages.getString(PKG, "TransLogTable.FieldName.Variable4"), BaseMessages.getString(PKG, "TransLogTable.FieldDescription.LogField"), ValueMetaInterface.TYPE_STRING, 255) );
		table.fields.add( new LogTableField(ID.VARIABLE5.id, true, true, "VARIABLE5", BaseMessages.getString(PKG, "TransLogTable.FieldName.Variable5"), BaseMessages.getString(PKG, "TransLogTable.FieldDescription.LogField"), ValueMetaInterface.TYPE_STRING, 255) );
