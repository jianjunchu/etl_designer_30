...
public class HTTPPOSTMeta extends BaseStepMeta implements StepMetaInterface
{
    ...
    public void getFields(RowMetaInterface inputRowMeta, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space) throws KettleStepException    
    {
        if (!Const.isEmpty(fieldName))
        {
        	...
        	if(this.isBinaryResult())
        		v = new ValueMeta(space.environmentSubstitute(fieldName), ValueMeta.TYPE_BINARY);
        	else
        		v = new ValueMeta(space.environmentSubstitute(fieldName), ValueMeta.TYPE_STRING);
...
public void setBinaryResult(boolean b) {
	// TODO Auto-generated method stub
	resultAsBinary = b;
}
}
