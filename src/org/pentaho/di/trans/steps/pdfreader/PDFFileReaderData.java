 ...
 * @since 22-jan-2005
 */
public class PDFFileReaderData extends BaseStepData implements StepDataInterface
{
	...
	//jason
	public int pagenr=0;  //current page no.
	public int pagesize=0; //total page size.
	public boolean pageInitFlag = false;
	//jason
