...
//	private static Class<?> PKG = Repository.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
	...
	public static final String TABLE_KDI_T_USER_RESOURCE   = "KDI_T_USER_RESOURCE";
	public static final String FIELD_C_USER_ID			   = "C_USER_ID";
	public static final String FIELD_C_RESOURCE_ID		   = "C_RESOURCE_ID";
	public static final String FIELD_C_RESOURCE_TYPE_ID    = "C_RESOURCE_TYPE_ID";
	
	public static final String TABLE_R_CACHE_FILE          = "R_CACHE_FILE";
	public static final String FIELD_ID_CACHE_FILE         = "ID_CACHE_FILE";
	public static final String FIELD_CACHE_FILE_NAME       = "NAME";
	public static final String FIELD_CACHE_FILE_FILEPATH   = "FILEPATH";
	public static final String FIELD_CACHE_FILE_MEMORYSIZE = "MEMORYSIZE";
	public static final String FIELD_CACHE_FILE_INDEXTYPE  = "INDEXTYPE";
  ...
  public static final String FIELD_SLAVE_WEB_APP_NAME = "WEB_APP_NAME";
    ...
    public static final String repositoryTableNames[] = new String[] 
         { 
    		...
    		, TABLE_R_TRANS_LOCK
    		, TABLE_R_JOB_LOCK
    		, TABLE_KDI_T_USER_RESOURCE
    		, TABLE_R_CACHE_FILE
         };

    /** The maximum length of a text field in a Kettle repository : 2.000.000 is enough for everyone ;-) */ 
    public static final int REP_STRING_LENGTH      = 8000; //edit by cli; the limit length of String in kingbase is 8000
