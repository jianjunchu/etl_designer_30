...
//                }
  ...
  public String[] getJobsWithIDList(ObjectId[] ids) throws KettleException
  {
	...
	private synchronized void insertJob(JobMeta jobMeta) throws KettleException
	{
		...
		//add by cli 777-780 save the access right info
		...
		userResourceTable.addValue(new ValueMeta(KettleDatabaseRepository.FIELD_C_RESOURCE_ID, ValueMetaInterface.TYPE_INTEGER), new LongObjectId(jobMeta.getObjectId()));
		userResourceTable.addValue(new ValueMeta(KettleDatabaseRepository.FIELD_C_RESOURCE_TYPE_ID, ValueMetaInterface.TYPE_INTEGER), new LongObjectId(2));
		...
		//add by cli 807-811 save the access right of the creater
