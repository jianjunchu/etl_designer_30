...
@DatabaseMetaPlugin(type="Kylin", typeDescription="Kylin")
public class KylinDatabaseMeta extends BaseDatabaseMeta
  implements DatabaseInterface
{
  protected static final String JAR_FILE = "kylin-jdbc-1.5.2.1.jar";
  protected static final String DRIVER_CLASS_NAME = "org.apache.kylin.jdbc.Driver";
  protected static final int DEFAULT_PORT = 7070;
  protected Integer driverMajorVersion;
  protected Integer driverMinorVersion;

  public KylinDatabaseMeta()
    throws Throwable
  {
  }

  KylinDatabaseMeta(int majorVersion, int minorVersion)
    throws Throwable
  {
    ...
    throws KettleDatabaseException
  {
    ...
    return "jdbc:kylin://" + hostname + ":" + port + "/" + databaseName;
  }
