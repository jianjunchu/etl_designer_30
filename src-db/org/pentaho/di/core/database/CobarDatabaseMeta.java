...
/**
 * Contains Cobar specific information through static final members 
 * 
 * @author JYHE
 */

public class CobarDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface
{
	...
	{
		if (getAccessType()==DatabaseMeta.TYPE_ACCESS_NATIVE) return 8066;
		return -1;
	}
