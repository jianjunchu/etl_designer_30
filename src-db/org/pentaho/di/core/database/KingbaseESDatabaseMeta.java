...
public class KingbaseESDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface
{
	...
	public String getFieldDefinition(ValueMetaInterface v, String tk, String pk, boolean use_autoinc, boolean add_fieldname, boolean add_cr)
	{
		...
		case ValueMetaInterface.TYPE_BOOLEAN:
			...
			break;
		case ValueMetaInterface.TYPE_INTEGER:  //edit by cli 
			retval+="INTEGER"; 
			break;
...
//			    ) 
//			{
//				retval+="BIGSERIAL";         //edit by cli kingbase doesn't support bigserial any more
//			} 
//			else
//			{
				if (length>0)
...
//			}
  ...
  public String getSQLListOfProcedures(String schemaName)
    ...
    public String getSQLLockTables(String tableNames[])
    {
        ...
        //edit by cli 20120827
        sql+=" IN ROW EXCLUSIVE MODE"+Const.CR; //ROW EXCLUSIVE MODE: UPDATE, DELETE, INSERT 语句自动请求这种锁。通常，任何修改表中数据的操作都会请求这种锁
     //   sql+="IN ACCESS EXCLUSIVE MODE;"+Const.CR;//ACCESS EXCLUSIVE MODE:ALTER TABLE, DROP TABLE, TRUNCATE, REINDEX, CLUSTER, VACUUM FULL 命令请求这种锁
