...
//    }
	...
	public static Double getLngLatPointDistance(ValueMetaInterface metaA,
			Object dataA, ValueMetaInterface metaB, Object dataB) {
		
		String[] A = dataA.toString().split(",");
		String[] B = dataB.toString().split(",");
		double lng1 = new Double(A[0]).doubleValue();
		double lat1 = new Double(A[1]).doubleValue();
		double lng2 = new Double(B[0]).doubleValue();
		double lat2 = new Double(B[1]).doubleValue();
